...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ContextRenderer'
        db.create_table(u'entity_event_contextrenderer', (
            ...
            ('render_group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['entity_event.RenderGroup'])),
            ('context_hints', self.gf('jsonfield.fields.JSONField')(default=None, null=True)),
        ))
        db.send_create_signal(u'entity_event', ['ContextRenderer'])
        ...
        db.add_column(u'entity_event_medium', 'render_group',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['entity_event.RenderGroup'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'ContextRenderer'
        db.delete_table(u'entity_event_contextrenderer')
    ...
    models = {
        ...
        u'entity_event.contextrenderer': {
            'Meta': {'object_name': 'ContextRenderer'},
        ...
        u'entity_event.medium': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '64'}),
            'render_group': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['entity_event.RenderGroup']", 'null': 'True'})
        },
