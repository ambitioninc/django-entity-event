...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'entity_event_contextrenderer', (
            ...
            ('source', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['entity_event.Source'], null=True)),
            ('source_group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['entity_event.SourceGroup'], null=True)),
            ('rendering_style', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['entity_event.RenderingStyle'])),
