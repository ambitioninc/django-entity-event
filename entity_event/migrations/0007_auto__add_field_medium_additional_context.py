...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Medium.additional_context'
        db.add_column(u'entity_event_medium', 'additional_context',
                      self.gf('jsonfield.fields.JSONField')(default=None, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Medium.additional_context'
        db.delete_column(u'entity_event_medium', 'additional_context')
    ...
    models = {
        ...
        u'entity_event.medium': {
            ...
            'additional_context': ('jsonfield.fields.JSONField', [], {'default': 'None', 'null': 'True'}),
