...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Medium.render_group'
        db.alter_column(u'entity_event_medium', 'render_group_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['entity_event.RenderGroup']))

    def backwards(self, orm):

        # Changing field 'Medium.render_group'
        db.alter_column(u'entity_event_medium', 'render_group_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['entity_event.RenderGroup'], null=True))
