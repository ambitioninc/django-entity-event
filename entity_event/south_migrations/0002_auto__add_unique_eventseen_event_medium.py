...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'EventSeen', fields ['event', 'medium']
        db.create_unique(u'entity_event_eventseen', ['event_id', 'medium_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'EventSeen', fields ['event', 'medium']
        db.delete_unique(u'entity_event_eventseen', ['event_id', 'medium_id'])
